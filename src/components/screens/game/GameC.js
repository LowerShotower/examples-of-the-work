...
import '../../data/frames';
import '../../library/resources.js';
import '../../library/sprite.js';
import '../../library/animator.js';
import '../../library/input.js';
import '../../library/renderer.js';
import '../../library/vector.js';

import lM from '../../screens/game/LevelM';
import {Player, Enemy, Explosion} from '../../entities/all.js';
import * as inGameMenu from './../../modals/in-game-menu/index';
import * as mNM from './../../managers/monsterNameM';
import * as uiM from '../../modals/uiManager';
import { setTimeout } from 'timers';

import './game.scss';
import './fonts/Lalezar-Regular.ttf';

import './img/terrain.jpg';
import './img/terrain2.jpg';
import './img/sprites/attacks.png';
import './img/sprites/entities.png';
import './img/sprites/explosions.png';
import './img/screenshots/ss1.jpg';
import './img/screenshots/ss2.jpg';
import './img/screenshots/ss3.jpg';

import './sounds/burn2.wav';
import './sounds/poison1.wav';
import './sounds/water2.wav';
import './sounds/earth1.wav';
import './sounds/wosh3.wav';
import './sounds/soundtrack2.mp3';
import './sounds/soundtrack5.mp3';
import './sounds/soundtrack4.mp3';
//********************************************************************************
...
events.on("animEnded", (e,objName,animName) => {
    ...
    switch(objName){
        case "player": switch(animName){
                            case "attack":  inGameMenu.disableTurnMainBtn();
                            ...
                            enemy.beingAttacked();
                            break;
                            case "attacked": inGameMenu.changeMainBtnText("Your Turn");
        }
        break;
        ...
        case "enemy": 
                        switch(animName){
                            case "attack":  inGameMenu.disableTurnMainBtn();
                                            ...
                                            inGameMenu.changeMainBtnText("Your Turn");
                            break;
...
events.on("enemyTurn", (e) => {
    inGameMenu.changeMainBtnText("Monster Turn");
    inGameMenu.disableTurnMainBtn();
    enemy.castSpell();
});
